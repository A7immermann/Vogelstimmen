...
const ICON_PAUSE = `<svg viewBox="0 0 24 24" width="22" height="22" fill="black" style="display:block;"><rect x="5" y="5" width="4" height="14" rx="1.5"/><rect x="15" y="5" width="4" height="14" rx="1.5"/></svg>`;
